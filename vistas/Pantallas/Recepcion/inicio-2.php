...
$todas_las_citas_2 = mysql_query("SELECT * FROM citas WHERE  fecha='$fecha_dato' AND (status=2 OR status=100) ORDER BY updated_at ASC");
...
<td>
<a role="button" class="btn btn-inverse" role="button" data-toggle="modal" class="btn btn-default" href="<?php echo "#myModaleditar".$i; ?>">Procedimientos</a>
<a href="<?php echo "#myModalGeneral".$i; ?><?php  ?>" role="button" data-toggle="modal" class="btn btn-default">Opciones</a>
</td>
</tr>
<!-- ////////////////////////////////Modal/////////////////////////////////////////////// -->
<!-- ////////// Modal general /////////////////-->
...
<a href="<?php echo "#myModalhora".$i; ?><?php  ?>" role="button" data-toggle="modal" class="btn btn-inverse">Cambiar Hora de llegada</a>							
<?php if ($datos_2['status']==100) { ?>
<a href="<?php echo "#myModalquitar".$i; ?><?php  ?>" role="button" data-toggle="modal" class="btn btn-primary">Poner en Sala de Espera</a>              
<?php }else { ?>
<a href="<?php echo "#myModalausente".$i; ?><?php  ?>" role="button" data-toggle="modal" class="btn btn-primary">Pasar a Ausente</a>              
 <?php }?>
<a href="<?php echo "#myModalfecha_2".$i; ?><?php  ?>" role="button" data-toggle="modal" class="btn btn-danger">Diferir Cita</a>							
</div>
...
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
<h3 id="myModalLabel">¿Esta seguro que desea la hora de la cita del paciente <?php echo $paciente_2['nombre_completo']; ?> </h3>
</div>
<div class="modal-body">
...
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
<h3 id="myModalLabel">¿Esta seguro que desea colocar ausente al paciente <?php echo $paciente_2['nombre_completo']; ?> </h3>
</div>
<div class="modal-body">
...
<center>
<input type="hidden" name="cita_id" value="<?php echo $datos_2['id'];?>"> 
<button name="ausente" type="submit" class="btn btn-danger">Si quiero ponerlo en espra nuevamente</button>
</center>
...
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
<h3 id="myModalLabel">¿Esta seguro que desea difeir la Fecha de la cita del paciente <?php echo $paciente_2['nombre_completo']; ?> </h3>
</div>
<div class="modal-body">
...
<a role="button" class="btn btn-success" href="../../PHP/recepcion/comfirmar_cita.php?id=<?php echo $datos['id'];?>&status=<?php echo $datos['status'];?>">Presente</a>
<a role="button" class="btn btn-default" role="button" data-toggle="modal" class="btn btn-default" href="<?php echo "#myModaleditar".$l; ?>">Editar</a>


<?php }else { ?> 

<a role="button" class="btn btn-default porconfirmar"  href="../../PHP/recepcion/comfirmar_cita.php?id=<?php echo $datos['id'];?>&status=<?php echo $datos['status'];?>">Confirmar</a>
<a role="button" class="btn btn-default" role="button" data-toggle="modal" class="btn btn-default" href="<?php echo "#myModaleditar".$l; ?>">Editar</a>
...
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
<h3 id="myModalLabel">¿Esta seguro que desea Cancelar cita del paciente <?php echo $paciente['nombre_completo']; ?> </h3>
</div>
<div class="modal-body">
...
<a role="button" class="btn btn-default" role="button" data-toggle="modal" class="btn btn-default" href="<?php echo "#myModalcambiar".$m; ?>">Editar</a>
<?php }else {?>
<a  role="button" class="btn btn-default porconfirmar" href="../../PHP/recepcion/comfirmar_cita.php?id=<?php echo $datos_3['id'];?>&status=<?php echo $datos_3['status'];?>">Confirmar</a>
<a role="button" class="btn btn-default" role="button" data-toggle="modal" class="btn btn-default" href="<?php echo "#myModalcambiar".$m; ?>">Editar</a>
...
<td class="iconos_reporte">
<?php if ($datos_3['status']==1) {  ?>
<a role="button"  data-toggle="modal" class="btn btn-default" href="<?php echo "#myModalcambiar".$m; ?>">Editar</a>
<?php }else {?>
<a  role="button" class="btn btn-default porconfirmar" href="../../PHP/recepcion/comfirmar_cita.php?id=<?php echo $datos_3['id'];?>&status=<?php echo $datos_3['status'];?>">Confirmar</a>
<a role="button" class="btn btn-default" data-toggle="modal"  href="<?php echo "#myModalcambiar".$m; ?>">Editar</a>
