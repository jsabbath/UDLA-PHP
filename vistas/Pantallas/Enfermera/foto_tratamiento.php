				...
				<div class="span6">
					<div class="widget">
						<div class="widget-header">
							...
							<h3>Foto-registro del procedimiento:</h3>
						</div> <!-- /widget-header -->
						...
						<div class="span6">
							<div class="widget">
								<div class="widget-header">
									<i class="icon-camera"></i>
									<h3>Visualización de foto capturada:</h3>
								</div> <!-- /widget-header -->
...
<script>
$(function(){
		var formulario = document.forms["foto_tipo"];
		var tipo = formulario.elements["tipo"];
      	var img=null;
	...
	sayCheese.start();
		...
		$('#guardarFoto').bind('click', function() {
			...
			$.ajax({
				url: '../../PHP/enfermera/guardar_foto.php?id=<?php echo $id;?>&paciente=<?php echo $paciente;?>',
				data: data,
				type: 'POST',
				success: function (msg) {
				window.location="../../Pantallas/Enfermera/foto_tratamiento.php?id=<?php echo $id;?>&paciente=<?php echo $paciente;?>";
				}
			});
		});	
}); 
